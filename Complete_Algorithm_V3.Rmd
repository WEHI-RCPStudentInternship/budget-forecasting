...
sources <- data.frame(
  ...
  ValidFrom = c("01/01/2025", "01/02/2025", "01/04/2025", "01/01/2025", "01/07/2025", "01/01/2025", "01/10/2025"),
...
for (i in 1:n_sources) {
  for (j in 1:n_expenses) {
    ...
    time_match_modified <- (e_date >= s_from)
...
```{r}
knitr::purl(input = "Complete_Algorithm_Alternative.Rmd", output = "Complete_Algorithm_Alternative_V3.R")
```